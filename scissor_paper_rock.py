...
Label(text = 'Rock Paper Scissors Game', font = font.Font(size = 20), bg = '#8a4c6b').pack()
...
winner_label = Label(text = "Let's start the Game...", fg = 'green', bg = '#f8faf0', font = font.Font(size = 13), pady = 8)
winner_label.pack()
...
score_label = Label(input_frame, text = 'Score : ', font = app_font, fg = 'grey', bg = '#b4ba9e')
score_label.grid(row = 2, column = 0)

player_choice_label = Label(input_frame, text = 'You Selected : ---', font = app_font, bg = '#b4ba9e')
player_choice_label.grid(row = 3, column = 1, pady = 5)

player_score_label = Label(input_frame, text = 'Your Score : 0', font = app_font, bg = '#b4ba9e')
player_score_label.grid(row = 3, column = 2, pady = 5)

computer_choice_label = Label(input_frame, text = 'Computer Selected : ---', font = app_font, fg = 'black', bg = '#b4ba9e')
computer_choice_label.grid(row = 4, column = 1, pady = 5)

computer_score_label = Label(input_frame, text = 'Computer Score : 0', font = app_font, fg = 'black', bg = '#b4ba9e')
